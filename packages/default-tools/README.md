...
CCDD 3.1.0 supports Node.js 22 LTS (22.19.0 or later). Install published versions with `npm install --ignore-scripts @ccdd/core @ccdd/default-tools`. Install `@ccdd/project` as well to use the project CLI.
