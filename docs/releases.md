...
See [getting started](getting-started.md) for setup and [v4.1.0 release notes](releases/v4.1.0.md) for the current changes.

## Installing and upgrading

CCDD 4.1.0 supports Node.js 22 LTS (22.19.0 or later). Install matching versions of the three packages:

```sh
npm install --ignore-scripts @ccdd/core@4.1.0 @ccdd/project@4.1.0 @ccdd/default-tools@4.1.0
...
```sh
gh workflow run release.yml --ref main -f tag=v4.1.0
```
