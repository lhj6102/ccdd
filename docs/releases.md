...
See [getting started](getting-started.md) for setup and [v3.2.0 release notes](releases/v3.2.0.md) for the current changes.

## Installing and upgrading

CCDD 3.2.0 supports Node.js 22 LTS (22.19.0 or later). Install matching versions of the three packages:
