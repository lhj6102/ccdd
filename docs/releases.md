...
Keep the core, Project, and default-tools `package.json` versions and lockfile versions aligned, and include `docs/releases/v<version>.md` in the commit. That document becomes the Release body. v2.0.1 uses [these release notes](releases/v2.0.1.md).
