...
```sh
export CCDD_DEMO_CORE_TARBALL=/tmp/ccdd-local-packages/ccdd-core-3.1.0.tgz
export CCDD_DEMO_TOOLS_TARBALL=/tmp/ccdd-local-packages/ccdd-default-tools-3.1.0.tgz
export CCDD_DEMO_DIR="$HOME/.local/share/ccdd/demo-3.1.0"
