# CCDD 4.1.0 — Script errors and execution diagnostics

This release adds explicit script domain errors and request-scoped execution diagnostics. All three packages move together to 4.1.0; Node.js support remains 22 LTS, at least 22.19.0.
...
Domain errors are recorded with an error outcome in timing diagnostics. Successful observations and semantic evidence remain separate from execution diagnostics.
