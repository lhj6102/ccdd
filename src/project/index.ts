...
export async function inspectProject<D extends ResultDetail = 'compact'>({ detail, repoPath, stateDir, selection, recursive = false, force = false, signal, workspaceIntegrity = 'content' }: { repoPath: string; stateDir: string; selection?: ProjectSelection; recursive?: boolean; force?: boolean; signal?: AbortSignal; workspaceIntegrity?: WorkspaceIntegrity } & ResultOptions<D>) {
