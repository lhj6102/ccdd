...
export interface ReviewEnvelope {
  ...
  payload: ReviewPayload; profile: CriticProfile; dependsOn: string | null;
}
...
export interface CriticDefinition { id: string; title: string; dependsOn: string | null; artifacts: string[]; profile: CriticProfile; payload: ReviewPayload }
export interface RepoConfig { artifacts: Record<string, { type: string; path: string }>; artifactTypes: Record<string, ArtifactTypeDefinition>; critics: CriticDefinition[] }
